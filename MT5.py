...
from mt5_package.activations import ACT2FN
from mt5_package.modeling_outputs import (
    BaseModelOutput,
    BaseModelOutputWithPastAndCrossAttentions,
    Seq2SeqLMOutput,
    Seq2SeqModelOutput,
)
from mt5_package.modeling_utils import PreTrainedModel
from mt5_package.pytorch_utils import find_pruneable_heads_and_indices, prune_linear_layer
from mt5_package.utils import (
    DUMMY_INPUTS,
    DUMMY_MASK,
...
class MiniMT5(MT5ForConditionalGeneration):
    ...
    def forward(
        ...
        inputs_embeds: Optional[torch.FloatTensor] = None,
        decoder_inputs_embeds: Optional[torch.FloatTensor] = None,
        lm_labels: Optional[torch.LongTensor] = None, # edited from `labels` in updated version
