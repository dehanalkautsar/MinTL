...
class _SMD_Config:
    def __init__(self, exp_setting):
        self._smd_init(exp_setting)

    def _smd_init(self, exp_setting): # copied from multiwoz_config
        # self.vocab_path_train = os.path.join(os.path.dirname(__file__), 'data/multi-woz-processed/vocab')
        # self.vocab_path_eval = None
...
smd_config_en = _SMD_Config('en')
smd_config_id = _SMD_Config('id')
smd_config_cross = _SMD_Config('cross')
smd_config_bi = _SMD_Config('bi')
smd_config_bien = _SMD_Config('bi-en')
smd_config_biid = _SMD_Config('bi-id')